                        ...
                        <div className="bg-white border-b border-gray-200 p-6 flex flex-col md:flex-row justify-between items-start gap-4 shadow-sm z-20">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white border border-slate-900 rounded-lg text-sm font-bold hover:bg-slate-800 w-full justify-center shadow-lg active:scale-95 transition-all"
                                >
