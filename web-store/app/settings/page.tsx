    ...
    const fetchSettings = async () => {
        ...
        if (data) {
            ...
            data.forEach((row: any) => {
                if (row.key === 'store_profile') newSettings.profile = row.value;
                if (row.key === 'operating_hours') newSettings.hours = row.value;
                if (row.key === 'order_rules') newSettings.rules = row.value;
            });
                    ...
                    <div className="max-w-lg space-y-6">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <input type="number" value={settings.rules.sla} onChange={e => updateSection('rules', 'sla', parseInt(e.target.value))} className="w-24 px-4 py-2 rounded-lg bg-gray-50 border border-gray-200 outline-none font-mono font-bold" />
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <input type="number" value={settings.rules.min_order} onChange={e => updateSection('rules', 'min_order', parseInt(e.target.value))} className="w-24 px-4 py-2 rounded-lg bg-gray-50 border border-gray-200 outline-none font-mono font-bold" />
                ...
                {activeTab === 'theme' && (
                    <div className="max-w-lg space-y-6">
                        ...
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-200 text-center">
                            ...
                            <p className="font-bold text-gray-600">Theme Customization</p>
                            <p className="text-xs text-gray-400">Upgrade to Pro to customize store colors.</p>
                        </div>
                    </div>
                )}
